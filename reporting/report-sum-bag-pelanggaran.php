...
if (isset($office) && isset($dept) && isset($start) && isset($end) && isset($div)) {
    ...
    if(mysqli_num_rows($query) > 0 ) {
        ...
        while($data = mysqli_fetch_assoc($query)){
            ...
            $sql_1 ="SELECT A.div_plg_cctv, A.id_head_jns_plg, COUNT(B.id_head_ctg_plg) AS total_1 FROM pelanggaran_cctv AS A INNER JOIN jenis_pelanggaran AS B ON A.id_head_jns_plg = B.id_jns_plg WHERE A.office_plg_cctv = '$office' AND A.dept_plg_cctv = '$dept' AND A.div_plg_cctv = '$div_detail' AND DATE(tgl_plg_cctv) BETWEEN '$start' AND '$end' AND B.id_head_ctg_plg = '1'";
            $cat1 = mysqli_fetch_assoc(mysqli_query($conn, $sql_1));

            $sql_2 ="SELECT A.div_plg_cctv, A.id_head_jns_plg, COUNT(B.id_head_ctg_plg) AS total_2 FROM pelanggaran_cctv AS A INNER JOIN jenis_pelanggaran AS B ON A.id_head_jns_plg = B.id_jns_plg WHERE A.office_plg_cctv = '$office' AND A.dept_plg_cctv = '$dept' AND A.div_plg_cctv = '$div_detail' AND DATE(tgl_plg_cctv) BETWEEN '$start' AND '$end' AND B.id_head_ctg_plg = '2'";
            $cat2 = mysqli_fetch_assoc(mysqli_query($conn, $sql_2));
            
            $sql_3 ="SELECT A.div_plg_cctv, A.id_head_jns_plg, COUNT(B.id_head_ctg_plg) AS total_3 FROM pelanggaran_cctv AS A INNER JOIN jenis_pelanggaran AS B ON A.id_head_jns_plg = B.id_jns_plg WHERE A.office_plg_cctv = '$office' AND A.dept_plg_cctv = '$dept' AND A.div_plg_cctv = '$div_detail' AND DATE(tgl_plg_cctv) BETWEEN '$start' AND '$end' AND B.id_head_ctg_plg = '3'";
            $cat3 = mysqli_fetch_assoc(mysqli_query($conn, $sql_3));

            $sql_4 ="SELECT A.div_plg_cctv, A.id_head_jns_plg, COUNT(B.id_head_ctg_plg) AS total_4 FROM pelanggaran_cctv AS A INNER JOIN jenis_pelanggaran AS B ON A.id_head_jns_plg = B.id_jns_plg WHERE A.office_plg_cctv = '$office' AND A.dept_plg_cctv = '$dept' AND A.div_plg_cctv = '$div_detail' AND DATE(tgl_plg_cctv) BETWEEN '$start' AND '$end' AND B.id_head_ctg_plg = '4'";
            $cat4 = mysqli_fetch_assoc(mysqli_query($conn, $sql_4));

            $sql_5 ="SELECT A.div_plg_cctv, A.id_head_jns_plg, COUNT(B.id_head_ctg_plg) AS total_5 FROM pelanggaran_cctv AS A INNER JOIN jenis_pelanggaran AS B ON A.id_head_jns_plg = B.id_jns_plg WHERE A.office_plg_cctv = '$office' AND A.dept_plg_cctv = '$dept' AND A.div_plg_cctv = '$div_detail' AND DATE(tgl_plg_cctv) BETWEEN '$start' AND '$end' AND B.id_head_ctg_plg = '5'";
            $cat5 = mysqli_fetch_assoc(mysqli_query($conn, $sql_5));

            $sql_6 ="SELECT A.div_plg_cctv, A.id_head_jns_plg, COUNT(B.id_head_ctg_plg) AS total_6 FROM pelanggaran_cctv AS A INNER JOIN jenis_pelanggaran AS B ON A.id_head_jns_plg = B.id_jns_plg WHERE A.office_plg_cctv = '$office' AND A.dept_plg_cctv = '$dept' AND A.div_plg_cctv = '$div_detail' AND DATE(tgl_plg_cctv) BETWEEN '$start' AND '$end' AND B.id_head_ctg_plg = '6'";
