...
$p3at = mysqli_real_escape_string($conn, $_POST["no-p3at"]);
...
$pdf->Cell(63 ,5,'',0,0);
$pdf->Cell(63 ,5, strtoupper($header['department_name'].' '.$header['office_name']), 0, 1, 'C');
