...
if (isset($_SESSION['PRINTBKSE'])){
    $_POST = $_SESSION['PRINTBKSE'];
    unset($_SESSION['PRINTBKSE']);
}
else {
...
$pdf->SetTitle('Berita Acara Kerusakan Sarana Elektrikal');
