        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Master Tabel SPP</h4>
                ...
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <button type="button" class="btn btn-primary square btn-min-width ml-1 mr-1 mb-1"
                                        data-toggle="modal" data-target="#entrystpp">Entry SPP</button>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-row">
                                                            <div class="col-md-12 mb-2">
                                                                <input class="form-control" type="hidden" name="statusid" value="<?= autoid('1', '2', 'id_spp', 'status_pembelian'); ?>">
                                                                <label>Nama Status Pembelian : </label>
                                                                <input type="text" name="statusname" placeholder="Nama Status Pembelian" class="form-control" required>
                                                            </div>
                                                            <div class="col-md-12 mb-2">
                        ...
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            <tbody>
                                <?php
                            $query = mysqli_query($conn, "SELECT * FROM status_pembelian");
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge badge-default badge-<?= $data['status_warna']; ?> badge-lg"><i class="ft-info"></i> Status Notification</span>
                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-icon btn-danger"><i class="ft-delete"
                                                data-toggle="modal"
                                                data-target="#delete<?= $data['id_spp']; ?>"></i></button>
                                    </td>
                                    <!-- Modal Delete -->
                                    <div class="modal fade text-left" id="delete<?= $data['id_spp']; ?>" role="dialog"
                                        aria-labelledby="myModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                        <form message="" method="post">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <input type="hidden" name="idspp" value="<?= $data['id_spp']; ?>">
                                                    <p> Are you sure to delete ID : <?= $data['id_spp']; ?></p>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn grey btn-outline-secondary"
                                                        data-dismiss="modal">Close</button>
