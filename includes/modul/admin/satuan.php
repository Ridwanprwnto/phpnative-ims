        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Master Tabel Satuan Barang</h4>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <button type="button" class="btn btn-primary square btn-min-width ml-1 mr-1 mb-1"
                                        data-toggle="modal" data-target="#entrysatuan">Entry Satuan</button>
                                    <div class="modal fade text-left" id="entrysatuan" role="dialog"
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-row">
                                                            <div class="col-md-12 mb-2">
                                                                <input class="form-control" type="hidden" name="satuanid" value="<?= autoid('2', '2', 'id_satuan', 'satuan'); ?>">
                                                                <label>Nama Satuan : </label>
                                                                <input type="text" name="satuan" placeholder="Satuan Name" class="form-control" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <form message="" method="post">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" name="idst" value="<?= $data['id_satuan']; ?>">
                                                    <input type="hidden" name="stname" value="<?= $data['nama_satuan']; ?>">
                                                    <p> Are you sure to delete ID : <?= $data['id_satuan']; ?></p>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn grey btn-outline-secondary"
                                                        data-dismiss="modal">Close</button>
