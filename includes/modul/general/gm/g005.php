        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="horz-layout-basic">Report Rekapitulasi Absensi</h4>
                ...
                <div class="card-content collpase show">
                    <div class="card-body card-dashboard">
                        <div class="row">
                            <div class="col-12">                
                            <form method="post" action="reporting/report-rekap-absensi.php" target="_blank">
                                <div class="form-row">   
                                    ...
                                    <div class="col-md-12 mb-2">
                                        ...
                                        <select class="select2 form-control block" style="width: 100%" type="text" name="employe-cetak" required>
                                            <option value="" selected disabled>Please Select</option>
                                            <?php
                                    ...
                                    <div class="col-md-12 mb-2">
                                        <label>Absensi : </label>
                                        <select class="select2 form-control block" style="width: 100%" data-placeholder="Please Select" multiple="multiple" type="text" name="absensicetak[]" required>
