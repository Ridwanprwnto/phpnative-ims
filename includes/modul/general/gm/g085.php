        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="horz-layout-basic">Report History Data Hasil Stock Opname</h4>
                ...
                <div class="card-content collpase show">
                    <div class="card-body card-dashboard">
                        <div class="row">
                            <div class="col-12">                
                            <form method="post" action="reporting/report-history-so.php" target="_blank">
                                <div class="form-row">   
                                    ...
                                    <div class="col-md-12 mb-2">
                                        ...
                                        <select class="select2 form-control" multiple="multiple" style="width: 100%" type="text" name="barangcetak[]" required>
                                            ...
                                            <?php 
                                                $query_plu = mysqli_query($conn, "SELECT A.*, B.IDBarang, B.NamaBarang, C.IDJenis, C.NamaJenis FROM barang_assets AS A
                                                ...
                                                while($data_plu = mysqli_fetch_assoc($query_plu)) { 
                                                    $dataplu = "'".$data_plu['pluid']."'"; ?>
                                                    <option value="<?= $dataplu;?>">
                                                    <?= $data_plu['pluid']." - ".$data_plu['NamaBarang']." ".$data_plu['NamaJenis'];?>
                                                </option>
                                                <?php 
                                                }
                                            ?>
