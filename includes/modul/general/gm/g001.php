        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="horz-layout-basic">Report Data Users</h4>
                ...
                <div class="card-content collpase show">
                    <div class="card-body card-dashboard">
                        <div class="row">
                            <div class="col-12">                
                            <form method="post" action="reporting/report-data-users.php" target="_blank">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-12 mb-2">
                                        ...
                                        <select class="select2 form-control block" style="width: 100%" type="text" name="div-cetak" required>
                                            <option value="" selected disabled>Please Select</option>
                                            <option value="ALL">ALL</option>
                                            <?php
