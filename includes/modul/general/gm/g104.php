                                ...
                                <form message="" method="post">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input type="hidden" id="code-laporbuatperiodeassest" name="code-laporbuatperiodeassest" class="form-control" readonly>
                                            <input type="hidden" id="leader-laporbuatperiodeassest" name="leader-laporbuatperiodeassest" class="form-control" readonly>
                                            <input type="hidden" id="name-laporbuatperiodeassest" name="name-laporbuatperiodeassest" class="form-control" readonly>
                                            <input type="hidden" id="tahun-laporbuatperiodeassest" name="tahun-laporbuatperiodeassest" class="form-control" readonly>
                                            <input type="hidden" id="office-laporbuatperiodeassest" name="office-laporbuatperiodeassest" class="form-control" readonly>
                                            <input type="hidden" id="divisi-laporbuatperiodeassest" name="divisi-laporbuatperiodeassest" class="form-control" readonly>
                                            <input type="hidden" name="trans-laporbuatperiodeassest" value="<?= $arrmodifref[12]; ?>" class="form-control" readonly>
    ...
    $(document).on('click', '.posting_datapenilaian', function(){  
        ...
        $.ajax({  
            ...
            success:function(data){
                ...
                $('#code-laporbuatperiodeassest').val(data.code_sts_assest);
                $('#leader-laporbuatperiodeassest').val(data.leader_data_assest);
                $('#name-laporbuatperiodeassest').val(data.full_name);
                $('#tahun-laporbuatperiodeassest').val(data.th_data_assest);
                $('#office-laporbuatperiodeassest').val(data.office_data_assest);
                $('#divisi-laporbuatperiodeassest').val(data.div_data_assest);
