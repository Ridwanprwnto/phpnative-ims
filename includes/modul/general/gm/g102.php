                                ...
                                <div class="row">
                                    <div class="col-12 mt-2">
                                        ...
                                        <form method="post" action="reporting/report-penilaian.php" target="_blank">
                                            <div class="form-row">   
                                                <input class="form-control" type="hidden" name="user-cetak" value="<?= $nik." - ".$username; ?>">
                                                ...
                                                <div class="col-md-6 mb-2">
                                                    <label>Bagian : </label>
                                                    <select class="select2 form-control block" style="width: 100%"
                                                        type="text" name="divisi-cetak" required>
                                                        <option value="" selected disabled>Please Select</option>
                                                        <?php 
                                                            $query_bag = mysqli_query($conn, "SELECT A.id_head_div, A.name_head_div FROM head_divisi AS A 
                                                            INNER JOIN divisi AS B ON A.id_head_div = B.id_head_divisi
                                                            WHERE B.id_divisi = '$div_id'");
                                                            while($data_bag = mysqli_fetch_assoc($query_bag)) {
                                                            ?>
                                                                <option value="<?= $data_bag['id_head_div']." - ".$data_bag['name_head_div']; ?>"><?= $data_bag['name_head_div']; ?></option>
                                                            <?php 
                                                            } 
                                                        ?>
                                                    </select>
            ...
            table.DataTable( {
                ...
                columns: [
                    ...
                    { 
                        ...
                        data: null,
                        render: function(data, type, row) {
                            if (row.FLAG_ASSESST == "Y") {
                                var btnFlagStatus = "disabled";
                            }
                            else if (row.FLAG_ASSESST == "N") {
                                var btnFlagStatus = "";
                            }
