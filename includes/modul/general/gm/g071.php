        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="horz-layout-basic">Report PP Vs Register DAT</h4>
                ...
                <div class="card-content collpase show">
                    <div class="card-body card-dashboard">
                        <div class="row">
                            <div class="col-12">                
                            <form method="post" action="reporting/report-register-dat.php" target="_blank">
                                <div class="form-row">   
                                    ...
                                    <div class="col-md-12 mb-2">
                                        ...
                                        <select class="select2 form-control" multiple="multiple" style="width: 100%" type="text" name="btbnocetak[]" required>
                                            <option value="ALL" >ALL</option>
                                            <?php 
                                                $query_btb = mysqli_query($conn, "SELECT id_penerimaan FROM penerimaan_pembelian WHERE office_penerimaan = '$office_id' AND dept_penerimaan = '$dept_id' ORDER BY id_penerimaan DESC");
                                                while($data_btb = mysqli_fetch_assoc($query_btb)) { 
                                                    $databtb = "'".$data_btb['id_penerimaan']."'"; ?>
                                                    <option value="<?= $databtb;?>">
                                                    <?= $data_btb['id_penerimaan'];?>
                                                </option>
                                                <?php 
                                                } 
                                            ?>
