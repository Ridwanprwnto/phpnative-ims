        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="horz-layout-basic">Report Data Permohonan Pembelian</h4>
                ...
                <div class="card-content collpase show">
                    <div class="card-body card-dashboard">
                        <div class="row">
                            <div class="col-12">                
                            <form method="post" action="reporting/report-data-pp.php" target="_blank">
                                <div class="form-row">   
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <input type="date" class="form-control" name="tgl-awal" max="<?=date('Y-m-d')?>" required>
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <label for="dateto">End Date</label>
                                        <input type="date" class="form-control" name="tgl-akhir" max="<?=date('Y-m-d')?>" required>
                                    </div>
                                </div>
