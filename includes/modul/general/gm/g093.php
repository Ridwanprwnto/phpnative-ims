        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="horz-layout-basic">Report Data Pengecekan Barang</h4>
                ...
                <div class="card-content collpase show">
                    <div class="card-body card-dashboard">
                        <div class="row">
                            <div class="col-12">                
                            <form method="post" action="reporting/report-list-equipment-checking.php" target="_blank">
                                <div class="form-row">   
                                    ...
                                    <div class="col-md-6 mb-2">
                                        <label>Kondisi : </label>
                                        <select class="select2 form-control" style="width: 100%" type="text" name="kondisi-cetak" required>
                                            <option value="ALL" >ALL</option>
