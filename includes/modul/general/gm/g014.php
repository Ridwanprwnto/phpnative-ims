...
if(isset($_POST["proses-bkse"])){
    if(ProsesBKSE($_POST) > 0 ){
        $alert = array("Success!", "BA Kerusakan Sarana Elektrikal Berhasil Dibuat", "success", "$redirect");
    }
    else {
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        <form class="form" id="form_bak" action="" method="post">
                            <div class="form-body">
                                <h4 class="form-section"><i class="la la-building"></i> Data Office</h4>
                                <div class="row">
                            ...
                            <div class="form-actions">
                                ...
                                <button type="button" data-toggle="modal" data-target="#modal-bkse" class="btn btn-primary">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header bg-primary white">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <label>Pastikan data yang di input sudah sesuai!, klik proses untuk melanjutkan membuat BAK</label>
                                            </div>
...
function ResetForm() {
    var element = document.getElementById("form_bak");
    element.reset()
    $("#form_bak").find('select').select2().val('').trigger('change');
}
</script>
