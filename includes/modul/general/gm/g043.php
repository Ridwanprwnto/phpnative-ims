        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="horz-layout-basic">Laporan Kartu Stock Mutasi Barang</h4>
                ...
                <div class="card-content collpase show">
                    <div class="card-body card-dashboard">
                        <div class="row">
                            <div class="col-12">
                                <form method="post" action="reporting/report-mutasi-barang.php" target="_blank">
                                    <div class="form-row">
                                        <div class="col-md-6 mb-2">
                                            <input type="hidden" id="user" class="form-control" name="user"
                                                value="<?= $user; ?>">
                                        ...
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <input type="date" name="tglawal" max="<?=date('Y-m-d')?>" class="form-control" required>
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <label>Periode Akhir : </label>
                                            <input type="date" name="tglakhir" max="<?=date('Y-m-d')?>" class="form-control" required>
                                        </div>
