        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="horz-layout-basic">Report Saldo Akhir Barang</h4>
                ...
                <div class="card-content collpase show">
                    <div class="card-body card-dashboard">
                        <div class="row">
                            <div class="col-12">                
                            <form method="post" action="reporting/report-saldo-akhir.php" target="_blank">
                                <div class="form-row">   
                                    ...
                                    <div class="col-md-12 mb-2">
                                        ...
                                        <select class="select2 form-control" multiple="multiple" data-placeholder="Please Select" style="width: 100%" type="text" name="barangcetak[]" required>
                                            ...
                                            <?php 
                                                ...
                                                WHERE A.ms_id_office = '$office_id' AND ms_id_department = '$dept_id'");
