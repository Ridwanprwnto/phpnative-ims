...
if(isset($_POST["updatedata"])){
    if(UpdateBarangStock($_POST) > 0 ){
        $datapost = $_POST["pluiddata"];
        $alert = array("Success!", "Item Barang ".$datapost." berhasil input penerimaan", "success", "$redirect");
    }
    else {
                                    ...
                                    <div class="modal-header bg-info white">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-row">
                                                ...
                                                <input class="form-control" type="hidden" name="userproses" value="<?= $usernik;?>" readonly>
                                                <input class="form-control" type="hidden" name="ppbid" value="<?= $dec_act;?>" readonly>
                                                <input class="form-control" type="hidden" name="spid-10" value="<?= $arrsp[9];?>" readonly>
                                                <input class="form-control" type="hidden" name="spid-11" value="<?= $arrsp[10];?>" readonly>
                                                <input class="form-control" type="hidden" name="sp3at" value="<?= $arrsp3at[3];?>" readonly>
                        ...
                        <div class="table-responsive">
                            <table class="table text-center">
                                ...
                                <?php
                                    ...
                                    WHERE pembelian.ppid = '$dec_act' AND pembelian.status_pp = '$arrsp[7]' OR pembelian.ppid = '$dec_act' AND pembelian.status_pp = '$arrsp[8]' GROUP BY detail_penerimaan_pembelian.id_penerimaan_detail ORDER BY detail_penerimaan_pembelian.id_penerimaan_detail ASC";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <!-- Modal Update -->
                                        <div class="modal fade text-left" id="update<?= $datapp['id_penerimaan_detail']; ?>" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                            <form action="" method="post">
                                                <div class="modal-content">
                                                    <div class="modal-header bg-primary white">
                                                        <h4 class="modal-title white" id="myModalLabel1">Input Penerimaan Barang : <?= $idb." - ".$namab; ?></h4>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-row">
                                                            ...
                                                            <div class="col-md-12 mb-2">
                                                                ...
                                                                <input class="form-control" type="date" name="tglterima" value="<?= substr($datapp["tgl_penerimaan"], 0, 10); ?>" required>
                                                            </div>
                                                            ...
                                                            <div class="col-md-6 mb-2">
                                                                ...
                                                                <input type="text" name="btbdata" value="<?= $datapp["no_btb"]; ?>" placeholder="Input Nomor Referensi (Opsional)" class="form-control">
                                                            </div>
                                                            <div class="col-md-3 mb-2">
                                                                <label>Qty Terima : </label>
                                                                <input type="number" name="qtyterima" value="<?= $datapp["qty_penerimaan"]; ?>" placeholder="Qty Terima" class="form-control">
                                                            </div>
                                                            <div class="col-md-3 mb-2">
                                                                <label>Qty PP : </label>
