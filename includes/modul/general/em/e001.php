        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        <div class="col-12">
                                <div class="form-group"><input class="form-control" type="hidden" name="username-so" id="username-so" value="<?= $username?>" readonly>
                                            ...
                                            <form action="" method="post" enctype="multipart/form-data" role="form">
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-row">
                                                        ...
                                                        <input class="form-control" type="hidden" name="user-so" value="<?= $username; ?>" readonly>
                                                        <div class="col-md-12 mb-2">
                                                            <label>Noref SO : </label>
                                                            <select name="noref-so" class="select2 form-control block" style="width: 100%" type="text" required>
                                                                <option value="" selected disabled>Please Select</option>
                            ...
                            <table class="table table-striped table-bordered zero-configuration text-center" id="tableProsesSO">
                                ...
                                ?>
                                    <tr id="<?= $data["id_so_asset"]; ?>" class="edit_tr">
                                        <th scope="row"><?= $no++; ?></th>
                                        <td><?= $data["pluid_so_asset"] .' - '. $data["NamaBarang"].' '.$data["NamaJenis"]." ".$data["ba_merk"]." ".$data["ba_tipe"];?></td>
                                        ...
                                        <td>
                                            <a title="<?= $data['photo_so_asset'] != NULL ? 'Lihat Bukti Foto' : ''; ?>" data-toggle="tooltip" data-placement="bottom" onclick="window.open('', 'popupwindow', 'scrollbars=yes,resizable=yes,width=auto,height=auto');return true" target="popupwindow" href="<?= $data['photo_so_asset'] != NULL ? "files/opname/index.php?id=".encrypt($data['photo_so_asset']) : '#'; ?>" class="<?= $data['photo_so_asset'] != NULL ? 'btn btn-icon btn-primary' : ''; ?>"><i class="<?= $data['photo_so_asset'] != NULL ? 'ft-image' : ''; ?>"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                                <!-- Modal Proses -->
...
$(document).ready(function() {
    ...
    $("#statusso_input_"+ID).show();
        ...
        var dataString = 'IDSO='+ ID +'&LOKASISO='+lokasi_so+'&STATUSSO='+status_so+'&USERSO='+user_so;
